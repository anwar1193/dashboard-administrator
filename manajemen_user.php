			...
			<div class="container-fluid">
				...
				<div class="row" style="margin-top: 10px">
					<div class="col-md-12">
						...
						<a href="tambah_user.php" class="btn btn-primary btn-sm" style="color: white">
							<i class="fa fa-plus"></i> Tambah User
						</a>

						<table class="table table-bordered" style="margin-top: 10px" id="tableDT">
							<thead>
							...
							<tbody>
								<?php  
									$result = tampil_data("SELECT * FROM tbl_user");
									$no=1;
								...
								<tr style="<?= $data['cabang']=='total' ? 'background-color: yellow; font-weight: bold;' : null; ?>">
									...
									<td style="font-weight: bold; color: white; text-align: center;">
										<a class="btn btn-success btn-xs" href="edit_user.php?id=<?php echo $data['id'] ?>">
											<i class="fa fa-edit"></i> Edit
										</a>

										<a class="btn btn-danger btn-xs" href="hapus_user.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Anda Yakin?')">
