<?php
	...
	$id = $_GET['id'];
	$data_user = tampil_data("SELECT * FROM tbl_user WHERE id=$id")[0];
					...
					<div class="col-md-4 offset-4">
						...
						<form method="post" action="">
							...
							<div class="form-group">
							  ...
							  <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control" autocomplete="off" required value="<?php echo $data_user['nama_lengkap'] ?>">
							</div>

							<div class="form-group">
							  <label for="username">Username :</label>
							  <input type="text" name="username" id="username" class="form-control" autocomplete="off" required value="<?= $data_user['username'] ?>">
							</div>
							...
							<div style="margin-top: 30px">
								...
								<button type="submit" class="btn btn-success btn-sm" name="update_user">
